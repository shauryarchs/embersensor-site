...
export async function fetchFirmsData(env, forceRefresh = false) {
    ...
    const url = `https://firms.modaps.eosdis.nasa.gov/api/area/csv/${FIRMS_API_KEY}/VIIRS_NOAA20_NRT/-180,-90,180,90/1`;
...
export async function refreshFirmsCache(env) {
    ...
    const firmsUrl = `https://firms.modaps.eosdis.nasa.gov/api/area/csv/${FIRMS_API_KEY}/VIIRS_NOAA20_NRT/-180,-90,180,90/1`;
